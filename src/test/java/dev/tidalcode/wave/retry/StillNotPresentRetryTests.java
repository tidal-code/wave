...
public class StillNotPresentRetryTests {
    ...
    public void retryTestIfVisible() {
        ElementFinder.find("#textInput").clear().sendKeys("Retry test").clear().sendKeys("QA").retryIf(notPresent("id:newElement"), 3);
        ElementFinder.find("id:newElement").shouldBe(present);
    }
