...
public class TheFindAllTest {
    ...
    public void findAllTest() {
        ElementFinder.findAll("tagName:div").get(3).shouldHave(exactText("QA"));
    }

    @Test
    public void findAllShouldBeVisible() {
        ElementFinder.findAll("tagName:div").get(3).shouldBe(visible);
    }

    @Test
    public void testThenandThenFindClick() {
        UIElement element = ElementFinder.find("id:testid1");
        element.thenFind("id:testid2").thenFind("tagName:div").thenFind("tagName:p").click();
    }

    @Test
    public void findAndFindAll() {
        ElementFinder.find("#testid1").thenFindAll("tagName:div").get(3).shouldBe(visible).shouldHave(matchingText("Automation"));
    }

    @Test
    public void findAllShouldBeVisibleToClick() {
        ElementFinder.findAll("tagName:div").get(3).shouldBe(visible).click();
    }

    @Test
    public void findAllCountTest() {
        int count = ElementFinder.findAll("tagName:div").size();
        Assert.assertEquals(10, count);
    }

    @Test
    public void testThenandThenFindP() {
        ElementFinder.find("id:testid1").thenFind("id:testid2").thenFind("tagName:div").thenFind("tagName:p").click();
        String text = ElementFinder.find("id:testid1").thenFind("id:testid2").thenFind("tagName:div").thenFind("tagName:p").getText();
    ...
    public void testThenandThenFindPx() {
        String text = ElementFinder.find("id:testid1").thenFind("id:testid2").thenFind("tagName:div").thenFindAll("tagName:p").get(0).getText();
        Assert.assertEquals("Tester", text);
    }

    @Test
    public void testThenAndThenFindAllP() {
        int number = ElementFinder.find("id:testid1").thenFind("id:testid2").thenFind("tagName:div").thenFindAll("tagName:p").size();
    ...
    public void testUIElementThenTest() {
        ...
        int number2 = ElementFinder.find("id:testid1").thenFind("id:testid2").thenFind("tagName:div").thenFindAll("tagName:p").size();
    ...
    public void testGetSize() {
        ElementFinder.findAll("xxxxxxx").shouldHave(size(0));
    }
