...
import static dev.tidalcode.wave.verification.conditions.Condition.*;
...
public class ConditionsTest {
    ...
    public void collectionConditionsMix() {
        open("https://google.co.nz");
        ElementFinder.findAll("//input").shouldHave(sizeLessThan(20), sizeGreaterThan(6));
    }

    @Test
    public void collectionConditionsSize0() {
        open("https://google.co.nz");
        ElementFinder.findAll("//inputXXX").shouldHave(size(0));
    }
    ...
    public void collectionSizeGreaterThan() {
        open("https://google.co.nz");
        ElementFinder.findAll("//input").shouldHave(sizeGreaterThan(7));
    }

    @Test
    public void collectionSizeLessThan() {
        open("https://google.co.nz");
        ElementFinder.findAll("//input").shouldHave(sizeLessThan(15));
    }

    @Test
    public void elementDisplayedTest() {
        open("https://google.co.nz");
        ElementFinder.find("//input").shouldBe(visible);
    }
