...
public class ReportBuilderTest {
    ...
    public void expectationFailureTest(){
        final ReportMatcher functionalMatcher = new Reporter.FunctionalFailure();
        String typeContent = "nz.co.wc.ui.framework.exceptions.ExpectationFailure";
    ...
    public void sqlServerExceptionShouldBeOtherTypeTest(){
        ...
        String typeContent = "nz.co.wc.api.base.exceptions.RuntimeTestException";
    ...
    public void runtimeTimeoutExceptionTest(){
        final ReportMatcher functionalMatcher = new Reporter.FunctionalFailure();
        String typeContent = "nz.co.wc.ui.framework.exceptions.RuntimeTestException";
