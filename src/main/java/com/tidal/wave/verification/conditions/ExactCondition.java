...
public class ExactCondition extends Condition {
    ...
    public void verify(Executor executor) {
        ...
        new FluentWait<>(executor)
                ...
                .withMessage(String.format("Expected value '%s' is not equal to actual value '%s'", value, executor.invokeCommand(FindTextData.class, "findTextData")))
                .until(e -> e.invokeCommand(FindTextData.class, "findTextData").equals(value));
    }
